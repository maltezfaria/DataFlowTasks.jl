...
Some example use cases of \DFT{}:  
  ...
  \begin{itemize} 
    \item \href{https://maltezfaria.github.io/DataFlowTasks.jl/dev/examples/cholesky/cholesky/}{\textbf<2->{Tiled cholesky factorization}}
    \item
...
\begin{exampleblock}<2>{Tiled Cholesky decomposition}
  \vspace{-10pt}
  \begin{align*}
    \begin{bmatrix}
      A_{11} & A_{12} \\
