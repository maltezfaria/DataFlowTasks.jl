...
# The critical path, highlighted in red, includes all cholesky factorizations of diagonal tiles, as well as the required tasks inbetween them.
...
#
# - `LoopVectorization.jl` can improve the performance of the sequential cholesky factorization of diagonal tiles
...
# parallelization strategy presented here. The performances of this
# implementation is assessed in the following plot, by comparison to MKL on the
# case of a 5000x5000 matrix decomposed in tiles of size 256x256.
#
