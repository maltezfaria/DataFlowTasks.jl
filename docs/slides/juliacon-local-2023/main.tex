...
\begin{frame}
  ...
  \center Input: $N \times N$ symmetric (block) matrix $A$
  \center Goal: compute upper-triangular $L$ such that $A = L L^\top$
  ...
  \only<6->{Ouput: $L^\top$ in the upper-triangular part of $A$}
