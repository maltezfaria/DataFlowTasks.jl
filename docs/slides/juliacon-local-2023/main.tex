...
\begin{frame}
  ...
  \begin{itemize}
    \item Input: $N \times N$ symmetric (block) matrix $A$
  ...
  \begin{columns}
    ...
    \begin{tikzpicture}[thick, scale=1, transform shape]
      ...
      \pic[fill=white] at (1,3) {square};
      \pic[fill=white] at (1,2) {square};
      \pic[fill=white] at (2,2) {square};
      \pic[fill=white] at (1,1) {square};
      \pic[fill=white] at (2,1) {square};
      \pic[fill=white] at (3,1) {square};

      % diagonal 1,1
      \only<2,3,4>{\pic[fill=yellow] at (1,4) {square};}
      \only<3,4>{
        % first row
        \pic[fill=orange] at (2,4) {square};
        \pic[fill=orange] at (3,4) {square};
        \pic[fill=orange] at (4,4) {square};
      }
      % draw an arrow from (1,4) to (2,4), (3,4) and (4,4)
      \only<3>{
        \draw[->, thick, gray!30] (1.5,4.75) -- (2.5,4.75);
        \draw[->, thick, gray!30] (1.5,4.5) -- (3.5,4.5);
        \draw[->, thick, gray!30] (1.5,4.25) -- (4.5,4.25);
      }
      % fill blocks below diagonal 1,1 in green
      \only<4>{
      \pic[fill=red] at (2,3) {square};
      \pic[fill=red] at (3,3) {square};
      \pic[fill=red] at (4,3) {square};
      \pic[fill=red] at (3,2) {square};
      \pic[fill=red] at (4,2) {square};
      \pic[fill=red] at (4,1) {square};
      }
      % draw arrows from first row into green blocks
      \only<4>{
        \draw[->, thick, gray!30] (2.5,4.5) -- (2.5,3.5);
        \draw[->, thick, gray!30] (3.375,4.5) -- (3.375,3.5);
        \draw[->, thick, gray!30] (3.625,4.5) -- (3.625,2.5);
        \draw[->, thick, gray!30] (4.25,4.5) -- (4.25,3.5);
        \draw[->, thick, gray!30] (4.5,4.5) -- (4.5,2.5);
        \draw[->, thick, gray!30] (4.75,4.5) -- (4.75,1.5);
      }
      \only<5->{
        % start the next iteration
        \pic[fill=gray!30] at (1,4) {square};
        \pic[fill=gray!30] at (2,4) {square};
        \pic[fill=gray!30] at (3,4) {square};
        \pic[fill=gray!30] at (4,4) {square};
      }
      \only<6->{
        % fill whole matrix with gray
        \pic[fill=gray!30] at (2,3) {square};
        \pic[fill=gray!30] at (3,3) {square};
        \pic[fill=gray!30] at (4,3) {square};
        \pic[fill=gray!30] at (3,2) {square};
        \pic[fill=gray!30] at (4,2) {square};
  ...
  \begin{columns}[T]
   ...
   \end{tikzpicture}
    ...
    \begin{onlyenv}<1>
      ...
      \begin{itemize}
      \item $\mathcal{O}(N)$ \textcolor{yellow}{cholesky factorizations}
